...
(
	ANSWER_STATUS_CD CHAR(3) NOT NULL UNIQUE COMMENT '回答ステータスコード : ''THK'' : 回答未提出
''ANS'' : 回答提出済み ',
...
(
	...
	DEAL_ID INT(10) NOT NULL COMMENT 'DealId : 
',
	ITEM_USE_HISTORY_ID INT NOT NULL COMMENT 'ItemUseHistoryID : 
',
...
(
	ITEM_USE_HISTORY_ID INT NOT NULL AUTO_INCREMENT COMMENT 'ItemUseHistoryId : 
',
	TEAM_ID INT UNSIGNED NOT NULL COMMENT 'チームID',
	ITEM_ID INT NOT NULL COMMENT 'ItemId : 0 : Item 1
1 : Item 2',
...
(
	...
	ANSWER_STATUS_CD CHAR(3) NOT NULL COMMENT '回答ステータス : ''THK'' : 回答未提出
''ANS'' : 回答提出済み ',
	PRIMARY KEY (TEAM_ID)
) COMMENT = 'チームマスタ';
